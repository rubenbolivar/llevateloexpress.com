...
const menuItems = [
  ...
  { text: 'Solicitudes', icon: <ApplicationIcon />, path: '/dashboard/solicitudes' },
  { text: 'Pagos', icon: <PaymentIcon />, path: '/dashboard/pagos' },
  { text: 'Productos', icon: <ProductIcon />, path: '/dashboard/productos' },
  { text: 'Usuarios', icon: <UserIcon />, path: '/dashboard/usuarios' },
